/*package com.example.dog_selector.src;
...
public class Main {
    ...
    static UserServiceImpl userController = new UserServiceImpl();
        ...
        while (true) {
            if (!isLogin && !adminIsLogin) {
                    ...
                    if (isLogin) {
                        ...
                        if (menu.equalsIgnoreCase("2")) {
                            ...
                            if (dog.getDogIs() != null) {
                                alreadyHasThatDog = ClientServiceImpl.hasThatDog(
                ...
                if (adminMenu.equalsIgnoreCase("m")) {
                    ...
                    ClientServiceImpl clientController = new ClientServiceImpl();
